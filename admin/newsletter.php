...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Newsletter | CouponXHosting</title>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example4" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                    <?php
                                    $data = $db_handle->runQuery("SELECT * FROM newsletter order by id desc");
                                                ...
                                                <div class="dropdown mx-auto text-end">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           onclick="newsletterDelete(<?php echo $data[$i]["id"]; ?>);">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.toString() === 'P') {
                            ...
                            Swal.fire(
                                'Deleted!',
                                'Your newsletter email has been deleted.',
                                'success'
                            ).then((result) => {
                                window.location = 'Newsletter';
                            });
