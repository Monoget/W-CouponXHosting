...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Dashboard | CouponXHosting</title>
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-warning invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM category order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Category</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-success invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM store order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Store</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM trending order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Trending Deal</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM offer order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Offer</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-dark invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM store_offer order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Store Offer</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-danger invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM blog_category order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Blog Category</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-purple invoice-card">
                        <div class="card-body d-flex">
                            <div class="icon me-3">
                                <svg width="35px" height="34px">
                                    <path fill-rule="evenodd" fill="rgb(255, 255, 255)"
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM blog order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Blog</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="card bg-pink invoice-card">
                        <div class="card-body d-flex">
                            <div class="icon me-3">
                                <svg width="33px" height="32px">
                                    <path fill-rule="evenodd" fill="rgb(255, 255, 255)"
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?php echo $row_count = $db_handle->numRows("SELECT * FROM newsletter order by id desc"); ?></h2>
                                <span class="text-white fs-18">Total Newsletter</span>
                            </div>
                        </div>
                    </div>
                </div>
