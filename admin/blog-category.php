...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Blog Category | CouponXHosting</title>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="Update">
                                        ...
                                        <?php $data = $db_handle->runQuery("SELECT * FROM blog_category where id={$_GET['catId']}"); ?>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="bc_name"
                                                       placeholder="Blog Category Name"
                                                       value="<?php echo $data[0]["bc_name"]; ?>" required>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            <div class="col-sm-6 mx-auto">
                                                <button type="submit" class="btn btn-primary w-25"
                                                        name="updateBlogCategory">Submit
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <table id="example4" class="display" style="min-width: 845px">
                                        ...
                                        for ($i = 0; $i < $row_count; $i++) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $row = $db_handle->numRows("SELECT * FROM blog WHERE blog_cate_id='{$category_data[$i]['id']}'");
                                                    echo $row;
                                                    ?>
                                                </td>
                                                <td>
                                                    <div class="dropdown mx-auto text-end">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                               href="Blog-Category?catId=<?php echo $category_data[$i]["id"]; ?>">Edit</a>
                                                            <a class="dropdown-item"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.toString() === 'P') {
                            Swal.fire(
                                'Not Deleted!',
                                'Your have blog in this category.',
                                'error'
                            ).then((result) => {
