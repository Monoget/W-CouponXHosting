...
<head>
    ...
    <title>Terms and Condition - CouponXHosting</title>
</head>
<body>
<!-- NAV Start -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Terms and Condition</h1>
                <p>
                    Welcome to Couponxhosting!
                </p>
                <p>
                    These terms and conditions outline the rules and regulations for the use of Couponxhosting.com's
                    Website, located at https://couponxhosting.com/.
                </p>
                <p>
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Couponxhosting if you do not agree to take all of the terms and conditions stated on this page.
                </p>
                <p>
                    ...
                    with and subject to, prevailing law of us. Any use of the above terminology or other words in the
                ...
                <p>
                    We employ the use of cookies. By accessing Couponxhosting, you agreed to use cookies in agreement
                    with the Couponxhosting.com's Privacy Policy.
                </p>
                <p>
                ...
                <p>
                    Unless otherwise stated, Couponxhosting.com and/or its licensors own the intellectual property
                    rights for all material on Couponxhosting. All intellectual property rights are reserved. You may
                    access this from Couponxhosting for your own personal use subjected to restrictions set in these
                ...
                <ul>
                    <li>Republish material from Couponxhosting</li>
                    <li>Sell, rent or sub-license material from Couponxhosting</li>
                    <li>Reproduce, duplicate or copy material from Couponxhosting</li>
                    <li>Redistribute content from Couponxhosting</li>
                </ul>
                <p>
                    Parts of this website offer an opportunity for users to post and exchange opinions and information
                    in certain areas of the website. Couponxhosting.com does not filter, edit, publish or review
                    Comments prior to their presence on the website. Comments do not reflect the views and opinions of
                    Couponxhosting.com,its agents and/or affiliates. Comments reflect the views and opinions of the
                    person who post their views and opinions. To the extent permitted by applicable laws,
                    Couponxhosting.com shall not be liable for the Comments or for any liability, damages or expenses
                    caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments
                    on this website.
                </p>
                <p>
                    Couponxhosting.com reserves the right to monitor all Comments and to remove any Comments which can
                ...
                <p>
                    You hereby grant Couponxhosting.com a non-exclusive license to use, reproduce, edit and authorize
                ...
                <p>
                    ...
                    compensates the absence of Couponxhosting.com; and (d) the link is in the context of general
                ...
                <p>
                    ...
                    website, you must inform us by sending an e-mail to Couponxhosting.com. Please include your name,
                ...
                <p>
                    No use of Couponxhosting.com's logo or other artwork will be allowed for linking absent a trademark
                    license agreement.
                </p>
                <p>
                    <b>iFrames</b>
